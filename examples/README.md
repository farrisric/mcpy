...
| `03_gcmc_surface_mace.py` | A production run: O on Ag(111) with a machine-learned potential, FIRE relaxation, chemical potentials derived from the potential itself. | `nvalchemi-toolkit[mace]`, GPU | hours |
