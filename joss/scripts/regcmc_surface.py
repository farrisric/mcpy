"""
Replica-exchange GCMC for Pd-Au alloy surfaces with H adsorption.

Usage (run with mpirun):
    mpirun -np <n_replicas> python regcmc_surface.py <surface_type> <delta_mu_H> <model_path> <device>
...
# ── Output ─────────────────────────────────────────────────────────────────────
results_dir = Path("../results") / f"regcmc_surface_{surface_type}"
